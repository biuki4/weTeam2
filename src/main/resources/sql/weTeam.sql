...
CREATE TABLE `user` (
	...
	`person_info` varchar(255) DEFAULT '' COMMENT '个人简介',
...
CREATE TABLE `admin` (
	...
	`user_type` tinyint(2) DEFAULT '3' COMMENT '用户类型 0-超管 1-一级管理员 2-二级管理员',
	PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;
...
CREATE TABLE `award` (
	`id` int(20) NOT NULL AUTO_INCREMENT,
	`user_id` int(20) NOT NULL COMMENT '对应user',
	`name` varchar(255) NOT NULL COMMENT '获奖名称',
	`type` tinyint(2) DEFAULT '5' COMMENT '比赛类型 0-院级 1-校级 2-市级 3-省级 4-国家级 5-国际级 6-其他',
	`brief` varchar(255) NOT NULL COMMENT '奖项',
	`paper_url` varchar(255) DEFAULT '' COMMENT '证书url',
	PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;
...
CREATE TABLE `game` (
	`id` int(20) NOT NULL AUTO_INCREMENT,
	`post_id` int(20) NOT NULL COMMENT '发布者',
	`game_name` varchar(255) NOT NULL COMMENT '比赛名称',
	`poster_url` varchar(255) DEFAULT '' COMMENT '海报',
	...
	`register_start_time` date NOT NULL COMMENT '比赛报名时间段',
	`register_end_time` date NOT NULL COMMENT '比赛报名时间段',
	`game_start_time` date NOT NULL COMMENT '比赛时间持续段',
	`game_end_time` date NOT NULL COMMENT '比赛时间持续段',
	`game_source` varchar(255) DEFAULT '' COMMENT '主办方',
	`game_type` tinyint(2) DEFAULT '7' COMMENT '比赛类型 0-不限 1-院级 2-校级 3-市级 4-省级 5-国家级 6-国际 7-其他' ,
	`category_id` int(20) DEFAULT '9' COMMENT '分类',
	`game_url` varchar(255) DEFAULT '' COMMENT '比赛链接',
	`register_url` varchar(255) DEFAULT '' COMMENT '报名链接',
	`team_size` int(5) DEFAULT '1' COMMENT '队伍规模',
...
CREATE TABLE `team` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `user_id` int(20) NOT NULL COMMENT '队长',
  `game_id` int(20) NOT NULL COMMENT '对应比赛',
  `create_time` date NOT NULL COMMENT '创建时间',
  `team_no`varchar(255) DEFAULT '' COMMENT '编号',
  `name`varchar(255) NOT NULL COMMENT '名称',
  `contact`varchar(255) NOT NULL COMMENT '联系方式',
  `brief` varchar(255) NOT NULL COMMENT '介绍',
  `size` int(5) DEFAULT 1 COMMENT '人数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `team_user` (
  ...
  `type` tinyint(2) DEFAULT '0' COMMENT '0-申请中  1-同意（即成员）  2-拒绝',
...
CREATE TABLE `academy` (
	`id` int(20) NOT NULL AUTO_INCREMENT,
	`name` varchar(255) NOT NULL COMMENT '学院',
	PRIMARY KEY (`id`)
...
CREATE TABLE `message` (
	`id` int(20) NOT NULL AUTO_INCREMENT,
	`create_time` date NOT NULL COMMENT '发送日期',
	`title` varchar(255) NOT NULL COMMENT '标题',
	`img_url` varchar(255) DEFAULT '' COMMENT '图片',
	`msg_content` longtext NOT NULL COMMENT '消息内容',
	`sender_id` int(20) NOT NULL COMMENT '发送人',
	`receiver_id` int(20) NOT NULL COMMENT '接收人',
	PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;
